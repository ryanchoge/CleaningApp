<?php require view_path('partials/header'); ?>
       <div class="container-fluid border rounded p-2 m-2   col-lg-4 mx-auto " style="background-image: linear-gradient(to bottom, #FFD0D0, #C1ECE4);">
            <form method="post"  >
            <center><h5  style="color: #1B6B93"> <i class="fa fa-user m-3"></i> Edit Admin</h5></center>
                <div class="mb-3 ">
                ...
                <div class="mb-3 ">
                    ...
                    <input name="userId" type="number" value=<?= $id ?> class="form-control <?= !empty($errors['description']) ?'border-danger':''?>" id="productFormControlInput1"  autofocus >
                    <?php if (!empty($errors['description'])) :?>
                    <small class="text-danger"><?=$errors['description']?></small>
                    <?php endif;?>
                </div>
